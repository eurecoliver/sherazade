    ...
    <div style={{ minHeight: '100vh', background: '#F3F0FF', padding: '1.5rem 1rem' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem', flexWrap: 'wrap' }}>
          ...
          <h1 style={{ margin: 0, fontSize: '1.5rem', fontWeight: 800, color: '#6C5CE7', flex: 1 }}>
            👥 Gestione Utenti
          </h1>
          <button
            onClick={openNew}
            style={{ padding: '0.6rem 1.25rem', background: '#6C5CE7', color: 'white', border: 'none', borderRadius: '10px', fontWeight: 700, cursor: 'pointer', fontSize: '0.9rem', fontFamily: 'inherit' }}
          >
            + Nuovo utente
          </button>
        </div>
