...
WSGI_APPLICATION = 'sherazade.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': config('POSTGRES_DB', default='sherazade'),
        'USER': config('POSTGRES_USER', default='sherazade'),
        'PASSWORD': config('POSTGRES_PASSWORD', default='sherazade_password'),
